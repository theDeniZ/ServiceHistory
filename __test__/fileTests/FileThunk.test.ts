...
} from '../../src/model/ServiceItem';
import {
  getServiceFromALine,
  getServiceItemsFromAnArray,
  serviceItemsToString,
  servicesToFileContent,
  serviceToString,
} from '../../src/redux/thunks/FileThunk';
...
test('service items from a correct array', () => {
  const itemsArray: string[] = [
    '6', '1', '0x1', '0', '0', '12', '0x1', '0', '0', '5',
    '0x1', '0', '0', '4', '0x1', '0', '0', '100', '0x1', '0', '0',
    '11', '0x1', '0', '0',
  ];
